...
public class ExampleActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		UrlItem nextItem = new UrlItem(ID_DOWN, "UC浏览器", null, getResources()
				.getDrawable(R.drawable.fileicon_default));
		UrlItem prevItem = new UrlItem(ID_UP, "新浪",
				"http://news.sina.com.cn/c/2013-08-22/173728021067.shtml",
				getResources().getDrawable(R.drawable.fileicon_default));
		UrlItem searchItem = new UrlItem(ID_SEARCH, "百度",
				"http://m.baidu.com/qwertwertyur/ewertyui123456",
				getResources().getDrawable(R.drawable.fileicon_default));
		UrlItem infoItem = new UrlItem(ID_INFO, "淘宝", "http://m.taobao.com",
				getResources().getDrawable(R.drawable.fileicon_default));
		UrlItem infoItem1 = new UrlItem(ID_INFO, "淘宝1", "http://m.taobao.com",
				getResources().getDrawable(R.drawable.fileicon_default));
		UrlItem infoItem2 = new UrlItem(ID_INFO, "淘宝2", "http://m.taobao.com",
				getResources().getDrawable(R.drawable.fileicon_default));
		UrlItem infoItem3 = new UrlItem(ID_INFO, "淘宝3", "http://m.taobao.com",
				getResources().getDrawable(R.drawable.fileicon_default));
		UrlItem infoItem4 = new UrlItem(ID_INFO, "淘宝4", "http://m.taobao.com",
				getResources().getDrawable(R.drawable.fileicon_default));
		...
		quickAction
				.setOnUrlItemClickListener(new UrlList.OnUrlItemClickListener() {
					@Override
					public void onItemClick(UrlList source, int pos,
							int actionId) {
		...
		// Set listener for action item clicked
		// quickAction.setOnUrlItemCloseBtnClickListener(new
		// UrlList.OnUrlItemCloseBtnClickListener() {
		// @Override
		// public void onItemCloseBtnClick(UrlList source, int pos, int
		// actionId) {
		// UrlItem actionItem = source.getUrlItem(pos);
		//
		// //here we can filter which action item was clicked with pos or
		// actionId parameter
		// Toast.makeText(getApplicationContext(), pos+":"+actionItem.getTitle()
